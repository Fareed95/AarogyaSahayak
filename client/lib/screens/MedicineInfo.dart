...
class MedicalInfo
  ...
  State<
    MedicalInfo
  >
  createState() => _MedicalInfoState();
}

class _MedicalInfoState
    extends
        State<
          MedicalInfo
        > {
  ...
  _getUserData(
    ...
    try {
      const String apiUrl = 'http://192.168.0.107:8000/api/getmedicine/';
            ...
            Row(
              children: [
                ...
                if (medicine['expiry_date'] !=
                        null &&
                    medicine['expiry_date'].isNotEmpty)
                  Text(
