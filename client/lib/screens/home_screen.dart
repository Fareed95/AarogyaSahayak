...
class _HomeScreenState
                              ...
                              _mockAshaWorkers.where(
                                (
                                  ...
                                  final matchesQuery =
                                      ...
                                      w['region'].toString().toLowerCase().contains(
                                        query,
                                      );
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(
                                    ...
                                    const SnackBar(
                                      content: Text(
                                        "Use my location: (stub) — add geolocation integration.",
                                      ),
                                    ),
                                  );
                                },
  ...
  Widget _buildNearestAshaSection(
    bool isDark,
  ) {
    return InkWell(
  ...
  Widget _buildYogaPoseAnalysisSection(
    bool isDark,
  ) {
    return InkWell(
      onTap: () {
