...
class Doctorinfo
  ...
  State<
    Doctorinfo
  >
  createState() => _DoctorinfoState();
}

class _DoctorinfoState
    extends
        State<
          Doctorinfo
        > {
  ...
  _submitMedicines() async {
    ...
    try {
      const String apiUrl = 'http://192.168.0.107:8000/api/postmedicine/';
      ...
      for (final medicine in _medicines) {
        ...
        if (response.statusCode ==
          ...
          AwesomeSnackbar.success(
            context,
            "Success",
            "Medicine ${medicine.name} added successfully",
          );
        } else {
  ...
  void _addDose() {
    if (_doseNameController.text.isNotEmpty &&
        _doseTimeController.text.isNotEmpty) {
      setState(
        () {
          _currentDoses.add(
            Dose(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_currentDoses.isNotEmpty) ...[
                        ...
                        ..._currentDoses.asMap().entries.map(
                          (
                            entry,
                          ) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  '${dose.doseTime} - ${dose.description}',
                                ),
                                trailing: IconButton(
                                  icon: const Icon(
                                    Icons.delete,
                                    ...
                                    if (medicine.doses.isNotEmpty) ...[
                                      ...
                                      ...medicine.doses.map(
                                        (
                                          ...
                                          child: Text(
                                            '• ${dose.doseName} at ${dose.doseTime}',
                                          ),
                                        ),
                                      ),
                                    ],
