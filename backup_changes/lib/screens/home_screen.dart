...
// import 'cart_screen.dart'; // <-- Uncomment if you have a CartScreen
    ...
    try {
      ...
      final response = await http.get(
        ...
        headers: <String, String>{
          ...
          'Authorization': 'Bearer $token', // Use only one
        },
      );
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        String errorMessage = errorData['message'] ?? errorData['error'] ?? "Request failed";
  ...
  Widget _buildQuickButtons() {
    return Column(
      ...
      children: [
        ...
        // Uncomment if CartScreen exists
        // ElevatedButton(
        //   onPressed: () {
        //     Navigator.push(
        //       context,
    ...
    return Column(
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            _buildFeatureButton(icon: Icons.medical_services, label: "Immediate Diagnosis", isDark: isDark, onTap: () {}),
            _buildFeatureButton(icon: Icons.people, label: "Communities", isDark: isDark, onTap: () {}),
            _buildFeatureButton(icon: Icons.chat, label: "AI Chat", isDark: isDark, onTap: () {}),
            _buildFeatureButton(icon: Icons.restaurant, label: "Nutrition", isDark: isDark, onTap: () {}),
            _buildFeatureButton(icon: Icons.summarize, label: "Report Summary", isDark: isDark, onTap: () {}),
            _buildFeatureButton(icon: Icons.medication, label: "Medicines", isDark: isDark, onTap: () {}),
          ],
        ),
      ],
    );
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(icon, size: 32, color: isDark ? Colors.blueGrey[300] : const Color(0xFF153D8A)),
